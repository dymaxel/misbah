...
class WebsiteSaleStockVariantController(WebsiteSaleVariantController):
    ...
    def get_combination_info_website(self, product_template_id, product_id, combination, add_qty, **kw):
        ...
        # customer_type = login_user.partner_id.Customer_Type
        # customer_packages = request.env['product.packaging'].sudo().search([('customer_type', '=', customer_type),('product_id','=',product_id)])
        # print("customer_type",customer_type)
        # print("ID",product_template_id)
        # print("customer_type",customer_type)
